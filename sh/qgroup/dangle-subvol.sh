...
_log "rm original subvol"
$BTRFS subvolume delete $subv
sync
_squota_json $mnt
...
# WHY DOES BTRFS SYNC; SLEEP; BTRFS SYNC WORK?
# OR SLEEP 60
# BUT NOT SYNC; SLEEP; SYNC
# OR ANY OTHER OBVIOUS COMBO OF SYNCS/SLEEPS?!
# AND 
